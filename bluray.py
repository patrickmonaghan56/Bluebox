...
from database_class import BLU_RAY
...
class BlurayGUI:
    def __init__(self,master,conn):
        ...
        self.tree["columns"] = ("BLU_RAY_ID","Movie_ID","Cost", "Rented_Out")

        self.tree.column("BLU_RAY_ID", width=90, minwidth=90,stretch=False)
        ...
        self.tree.heading("BLU_RAY_ID", text="BLU_RAY_ID", anchor=tk.W)
        ...
        self.tree.grid(row=10, column=1, ipadx=0,pady=5,sticky=tk.W)
